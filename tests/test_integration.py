...
""")
    ...
    def test_end_to_end_agents_md_integration(
        ...
        assert len(claude_command_files) == 8, f"Expected 8 Claude commands, got {len(claude_command_files)}"
        assert len(augment_command_files) == 8, f"Expected 8 Augment commands, got {len(augment_command_files)}"
